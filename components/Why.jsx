      ...
      <div className={styles.container}>
        ...
        <div className={styles.why_container}>
          <div className={styles.why}>
            <img src={responsive.src} alt="Responsive And Fluid Design" />
          ...
          <div className={styles.why}>
            <img src={practices.src} alt="best website development practices" />
          ...
          <div className={styles.why}>
            <img src={modern.src} alt="modern website development" />
            ...
            <p>
              ...
              icons, fonts, pictures and other media, so as to ensure an
